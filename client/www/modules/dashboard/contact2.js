angular.module("buddySms.contact2", ["ngTable", "ngTableDemos"]);

(function() {
  "use strict";

  angular.module("buddySms.contact2").controller("demoController", demoController);
...
(function() {
  ...
  angular.module("buddySms.contact2").controller("dynamicDemoController", dynamicDemoController);
...
(function() {
  ...
  angular.module("buddySms.contact2").run(configureDefaults);
...
(function() {
  angular.module("buddySms.contact2").directive("demoTrackedTable", demoTrackedTable);
...
(function() {
  angular.module("buddySms.contact2").directive("demoTrackedTableRow", demoTrackedTableRow);
...
(function() {
  angular.module("buddySms.contact2").directive("demoTrackedTableCell", demoTrackedTableCell);
